...
import { hermesAdapter, getHermesPlanWarnings } from '../packages/cli/dist/install/adapters/hermes.js';
...
const resolvedProfile = {
  profile: {
    id: 'test-profile-id', name: 'My Skill Bundle', description: 'Test profile with skills + rules',
    version: '2.1.0', target: 'hermes', scope: 'personal', ownerId: null,
    entries: [
  ...
  artifacts: [
    { entryId: 'skill-1', kind: 'skill', resource: {
      id: 'skill-1', key: 'skill:tdd', kind: 'skill', name: 'tdd-workflow', description: 'TDD workflow skill.',
    ...
    { entryId: 'skill-2', kind: 'skill', resource: {
      id: 'skill-2', key: 'skill:multi', kind: 'skill', name: 'multi-file-skill', description: 'A multi-file skill.',
      version: '1.0.0', source: { type: 'inline-bundle', files: {
    ...
    { entryId: 'rule-1', kind: 'rule', resource: {
      id: 'rule-1', key: 'rule:core', kind: 'rule', name: 'core-rules', description: 'Core rules.',
      version: '1.0.0', source: { type: 'inline', content: '# Core Rules\n\nAlways write tests.\nUse TypeScript.' },
      scope: 'personal', ownerId: null, targets: ['hermes'], createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z',
    }},
    { entryId: 'sub-1', kind: 'sub_agent', resource: {
      id: 'sub-1', key: 'sub_agent:reviewer', kind: 'sub_agent', name: 'reviewer', description: 'Code reviewer.',
      version: '1.0.0', source: { type: 'inline', content: 'reviewer' },
      scope: 'personal', ownerId: null, targets: ['hermes'], createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z',
    }},
    { entryId: 'hook-1', kind: 'hook', resource: {
      id: 'hook-1', key: 'hook:precommit', kind: 'hook', name: 'pre-commit', description: 'Pre-commit hook.',
      version: '1.0.0', source: { type: 'inline', content: '{}' },
      scope: 'personal', ownerId: null, targets: ['hermes'], createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z',
    }},
  ],
...
console.log(plan.operations.map((o, i) => `  [${i+1}] ${o.kind} → ${o.destinationPath.replace(OUT, '~')}`).join('\n'));

applyInstall(plan, { profileId: 'test-profile-id', profileName: 'My Skill Bundle', profileVersion: '2.1.0' });
