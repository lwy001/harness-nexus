...
// See `wiki research-phase-3-ecc-install-patterns.md` +
// `wiki research-phase-8-t1-deepseek-harness.md` +
// `wiki research-phase-9-w12-opencode.md` + `wiki research-phase-9-w16-pi-agent.md`.
